  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, i, u, l) {
      ...
      for (l.set(e, t), l.set(t, e); ++d < s; ) {
        var v = e[d],
          y = t[d];
        if (i) var b = c ? i(y, v, d, t, e, l) : i(v, y, d, e, t, l);
        if (void 0 !== b) {
          if (b) continue;
          h = !1;
          break;
  ...
  function (e, t, n) {
    ...
    function Qa(e, t, n, r, o, a) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (Ua.current = null === e || null === e.memoizedState ? yi : bi),
        (e = n(r, o)),
        t.expirationTime === Ba)
      ) {
        a = 0;
              ...
              : ((n = null !== r),
                ...
                n &&
                  ...
                  0 != (1 & Ma.current)
                    ? Tu === wu && (Tu = xu)
                    : ((Tu !== wu && Tu !== xu) || (Tu = Eu),
                      0 !== Ru && null !== Ou && (Dl(Ou, Cu), Al(Ou, Ru)))),
                (n || r) && (t.effectTag |= 4),
                null)
          );
        case 4:
    ...
    function Gu(e, t) {
      ...
      return (
        null !== o && (Ou === o && (il(t), Tu === Eu && Dl(o, Cu)), Al(o, t)), o
      );
    }
    function Yu(e) {
    ...
    function Ju(e, t) {
      if (((Wu = 0), t)) return Il(e, (t = qu())), Xu(e), null;
      var n = Yu(e);
      if (0 !== n) {
      ...
      if (
        ...
        do {
          try {
            for (w = e; null !== Iu; ) {
              var k = Iu.effectTag;
              if ((36 & k && au(w, Iu.alternate, Iu), 128 & k)) {
                x = void 0;
                var O = Iu.ref;
                if (null !== O) {
                  var S = Iu.stateNode;
    ...
    function gl(e, t, n) {
      ...
      null !== r && r.delete(t),
        Ou === e && Cu === n
          ? Tu === Eu || (Tu === xu && 1073741823 === _u && Fo() - Au < 500)
            ? nl(e, Cu)
            : (Du = !0)
          : Rl(e, n) &&
      ...
      (t.unstable_scheduleCallback = function (e, n, i) {
        ...
        return (
          ...
          l > u
            ...
            : ((e.sortIndex = i), S(_, e), I || A || ((I = !0), r(U))),
          e
        );
      }),
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n, a, i, u) {
      ...
      for (var m = l; ++f < s; ) {
        var v = e[(p = c[f])],
          y = t[p];
        if (a) var b = l ? a(y, v, p, t, e, u) : a(v, y, p, e, t, u);
        if (!(void 0 === b ? v === y || i(v, y, n, a, u) : b)) {
          h = !1;
          break;
        }
        m || (m = "constructor" == p);
  ...
  function (e, t, n) {
    ...
    e.exports = function (e, t, n) {
      ...
      e: for (; ++b < f && v.length < m; ) {
        var w = y[b],
          x = t ? t(w) : w;
        if (((w = n || 0 !== w ? w : 0), !(g ? l(g, x) : s(v, x, n)))) {
          for (d = p; --d; ) {
            var E = h[d];
  ...
  function (e, t, n) {
    ...
    function N(e) {
      ...
      var t = window.history,
        ...
        a = n.hashType,
        i = void 0 === a ? "slash" : a,
        u = e.basename ? g(v(e.basename)) : "",
        l = T[i],
        c = l.encodePath,
        s = l.decodePath;
      function p() {
        var e = s(_());
        return u && (e = b(e, u)), x(e);
      }
      var d = E();
      function h(e) {
          ...
          d.confirmTransitionTo(n, "PUSH", o, function (e) {
            if (e) {
              ...
              if (_() !== r) {
                ...
                var o = A.lastIndexOf(w(U.location)),
                  a = A.slice(0, o + 1);
      ...
      return function (t) {
        ...
        function h(n) {
          ...
          var v = m ? n.store : h.store,
            ...
            E = Object(o.useMemo)(
              function () {
                return m ? h : f({}, h, { subscription: g });
              },
              [m, h, g]
            ),
            k = Object(o.useReducer)(ge, ye, ke),
            O = k[0][0],
            S = k[1];
          ...
          we(xe, [T, C, _, c, j, P, w]),
            we(Ee, [d, v, g, y, T, C, _, P, w, S], [v, g, y]);
        ...
        if (((v.WrappedComponent = t), (v.displayName = r), y)) {
          ...
          return (b.displayName = r), (b.WrappedComponent = t), F()(b, t);
        }
        return F()(v, t);
      };
    }
    ...
    var wt = { registry: [], bootstrapped: !1 },
      xt = function () {
        ...
        switch (t.type) {
          case tt:
            return bt({}, e, { registry: [].concat(vt(e.registry), [t.key]) });
          case et:
            var n = e.registry.indexOf(t.key),
              r = vt(e.registry);
            return (
              r.splice(n, 1),
              bt({}, e, { registry: r, bootstrapped: 0 === r.length })
            );
          default:
            return e;
        }
    ...
    function yn(e, t) {
      return !t || ("object" !== mn(t) && "function" != typeof t) ? vn(e) : t;
    }
    function bn(e) {
    ...
    var En = function (e, t) {
        "function" != typeof e
          ? null !== e && "object" === mn(e) && (e.current = t)
          : e(t);
      },
      kn = (function (e) {
        function t() {
          ...
          return (
            xn(
              vn((n = yn(this, (e = bn(t)).call.apply(e, [this].concat(o))))),
              "prevNode",
              null
            ),
            n
          ...
          hn(t, [
            {
              ...
              value: function () {
                (this.prevNode = i.findDOMNode(this)),
                  En(this.props.innerRef, this.prevNode);
              },
            },
            {
              key: "componentDidUpdate",
              value: function (e) {
                ...
                this.prevNode !== t &&
                  ((this.prevNode = t), En(this.props.innerRef, t)),
                  e.innerRef !== this.props.innerRef &&
                    En(this.props.innerRef, t);
              },
            },
            {
              key: "componentWillUnmount",
              value: function () {
                En(this.props.innerRef, null);
              },
            },
            {
              key: "render",
    ...
    xn(kn, "displayName", "RefFindNode"), xn(kn, "propTypes", {});
    var On = (function (e) {
      function t() {
        var e, n;
        pn(this, t);
    ...
    xn(On, "displayName", "RefForward"), xn(On, "propTypes", {});
    var Sn = function (e) {
      var t = e.children,
        n = e.innerRef,
        r = o.Children.only(t),
        a = L.isForwardRef(r) ? On : kn;
    ...
    var Cn = Sn,
      ...
      Rn = function (e, t) {
        return Pn()(o.Children.toArray(e), { type: t });
      },
      Dn = function (e) {
    ...
    function Yn(e, t, n) {
      ...
      if (d.className || v.className || h.className) {
        var b = Xt()(d.className, v.className, h.className);
        y.className = Ln()(b.split(" ")).join(" ");
      }
      if (
        ...
        fn()(g)
          ? x && (i || u) && (y.key = n)
          : ((y.key = "function" == typeof g ? g(y) : g), delete y.childKey);
      }
      return c
    ...
    Xn("div", function (e) {
      ...
      Xn("iframe", function (e) {
        return { src: e };
      }),
      Xn("img", function (e) {
        return { src: e };
      });
    var Jn = Xn("input", function (e) {
        return { type: e };
      }),
      Zn = Xn("label", function (e) {
        return { children: e };
      });
    Xn("p", function (e) {
      return { children: e };
      ...
      nr = (function (e) {
        function t() {
          ...
          for (var r = arguments.length, o = new Array(r), a = 0; a < r; a++)
            o[a] = arguments[a];
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
            Wt()(Bt()(n), "handleClick", function (e) {
              n.props.disabled
                ? e.preventDefault()
                : Kt()(n.props, "onClick", e, n.props);
            }),
            n
          );
        }
          ...
          It()(t, [
            {
              ...
              value: function () {
                var e = {},
                  ...
                  r = t["aria-hidden"];
                return (
                  fn()(n) ? (e["aria-hidden"] = "true") : (e["aria-label"] = n),
                  fn()(r) || (e["aria-hidden"] = r),
                  e
                );
              },
            },
            {
              ...
              value: function () {
                ...
                return a.a.createElement(
                  g,
                  Nt()({}, b, w, { className: y, onClick: this.handleClick })
                );
              },
            },
          ]),
    ...
    var rr = nr,
      ...
      hr = ["alt", "height", "src", "srcSet", "width"],
      mr = function (e) {
        var t =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          n = t.htmlProps,
      ...
      vr =
        "object" ===
          ("undefined" == typeof document ? "undefined" : Zt()(document)) &&
        null !== document,
      yr =
        "object" ===
          ("undefined" == typeof window ? "undefined" : Zt()(window)) &&
        null !== window &&
        window.self === window,
      br = function e() {
        return fn()(e.override) ? vr && yr : e.override;
      },
      gr = n(17),
      wr = n.n(gr),
      xr = n(14),
      ...
      Cr = n.n(Sr),
      Tr = function (e, t) {
        if (jn()([t, e], fn.a)) return !1;
        if (
          t.target &&
          (Kt()(t.target, "setAttribute", "data-suir-click-target", !0),
          document.querySelector("[data-suir-click-target=true]"))
        )
          return (
            Kt()(t.target, "removeAttribute", "data-suir-click-target"),
            e.contains(t.target)
          );
        var n = t.clientX,
          r = t.clientY;
        if (jn()([n, r], fn.a)) return !1;
      ...
      Ar = (function (e) {
        function t() {
          ...
          for (var r = arguments.length, o = new Array(r), a = 0; a < r; a++)
            o[a] = arguments[a];
          (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
            Wt()(Bt()(n), "trySetState", function (e, t) {
          ...
          var i = n.constructor.autoControlledProps,
            u = Kt()(Bt()(n), "getInitialAutoControlledState", n.props) || {},
            l = i.reduce(function (e, t) {
              return (e[t] = Dr(t, n.props, u, !0)), e;
            }, {});
      ...
      Ir = (function (e) {
        function t() {
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
            Wt()(Bt()(n), "handleRef", function (e) {
              En(n.props.innerRef, e);
            }),
            n
          );
        }
          ...
          It()(t, [
            {
              key: "componentDidMount",
              value: function () {
                Kt()(this.props, "onMount", null, this.props);
              },
            },
            {
              key: "componentWillUnmount",
              value: function () {
                Kt()(this.props, "onUnmount", null, this.props);
              },
            },
            {
              key: "render",
              value: function () {
                ...
                return Object(i.createPortal)(
                  a.a.createElement(Cn, { innerRef: this.handleRef }, t),
                  r
                );
              },
            },
      ...
      Lr = (function (e) {
        function t() {
          ...
          for (var r = arguments.length, a = new Array(r), i = 0; i < r; i++)
            a[i] = arguments[i];
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(a)))),
            Wt()(Bt()(n), "contentRef", Object(o.createRef)()),
            Wt()(Bt()(n), "triggerRef", Object(o.createRef)()),
            Wt()(Bt()(n), "latestDocumentMouseDownEvent", null),
            Wt()(Bt()(n), "handleDocumentMouseDown", function (e) {
              n.latestDocumentMouseDownEvent = e;
            }),
            Wt()(Bt()(n), "handleDocumentClick", function (e) {
              var t = n.props.closeOnDocumentClick,
                r = n.latestDocumentMouseDownEvent;
              (n.latestDocumentMouseDownEvent = null),
                !n.contentRef.current ||
                  Tr(n.triggerRef.current, e) ||
                  (r && Tr(n.contentRef.current, r)) ||
                  Tr(n.contentRef.current, e) ||
                  (t && n.close(e));
            }),
            Wt()(Bt()(n), "handleEscape", function (e) {
              n.props.closeOnEscape &&
                Er.a.getCode(e) === Er.a.Escape &&
                n.close(e);
            }),
            Wt()(Bt()(n), "handlePortalMouseLeave", function (e) {
              var t = n.props,
            ...
            Wt()(Bt()(n), "handlePortalMouseEnter", function () {
              n.props.closeOnPortalMouseLeave &&
                clearTimeout(n.mouseLeaveTimer);
            }),
            Wt()(Bt()(n), "handleTriggerBlur", function (e) {
              for (
                var t = n.props,
                  r = t.trigger,
                ...
                i[u - 1] = arguments[u];
              Kt.a.apply(void 0, [r, "props.onBlur", e].concat(i));
              var l = e.relatedTarget || document.activeElement,
                c = Kt()(n.contentRef.current, "contains", l);
              o && !c && n.close(e);
            }),
            Wt()(Bt()(n), "handleTriggerClick", function (e) {
              for (
                var t = n.props,
                  r = t.trigger,
                ...
                l[c - 1] = arguments[c];
              Kt.a.apply(void 0, [r, "props.onClick", e].concat(l)),
                i && o ? n.close(e) : !i && a && n.open(e);
            }),
            Wt()(Bt()(n), "handleTriggerFocus", function (e) {
              for (
                var t = n.props,
                  r = t.trigger,
                ...
                i[u - 1] = arguments[u];
              Kt.a.apply(void 0, [r, "props.onFocus", e].concat(i)),
                o && n.open(e);
            }),
            Wt()(Bt()(n), "handleTriggerMouseLeave", function (e) {
              ...
              for (
                ...
                u[l - 1] = arguments[l];
              Kt.a.apply(void 0, [r, "props.onMouseLeave", e].concat(u)),
                o && (n.mouseLeaveTimer = n.closeWithTimeout(e, a));
            }),
            Wt()(Bt()(n), "handleTriggerMouseEnter", function (e) {
              clearTimeout(n.mouseLeaveTimer);
              for (
                var t = n.props,
                  r = t.trigger,
                ...
                u[l - 1] = arguments[l];
              Kt.a.apply(void 0, [r, "props.onMouseEnter", e].concat(u)),
                a && (n.mouseEnterTimer = n.openWithTimeout(e, o));
            }),
            Wt()(Bt()(n), "open", function (e) {
              var t = n.props.onOpen;
              t && t(e, n.props), n.trySetState({ open: !0 });
            }),
            Wt()(Bt()(n), "openWithTimeout", function (e, t) {
              var r = In()({}, e);
              return setTimeout(function () {
                return n.open(r);
              }, t || 0);
            }),
            Wt()(Bt()(n), "close", function (e) {
              var t = n.props.onClose;
              t && t(e, n.props), n.trySetState({ open: !1 });
            }),
            Wt()(Bt()(n), "closeWithTimeout", function (e, t) {
              var r = In()({}, e);
              return setTimeout(function () {
                return n.close(r);
              }, t || 0);
            }),
            Wt()(Bt()(n), "handleMount", function () {
              Kt()(n.props, "onMount", null, n.props);
            }),
            Wt()(Bt()(n), "handleUnmount", function () {
              Kt()(n.props, "onUnmount", null, n.props);
            }),
            Wt()(Bt()(n), "handleTriggerRef", function (e) {
              (n.triggerRef.current = e), En(n.props.triggerRef, e);
            }),
            n
          );
        }
    ...
    Wt()(Lr, "defaultProps", {
      ...
      Wt()(Lr, "autoControlledProps", ["open"]),
      Wt()(Lr, "Inner", Mr),
      Wt()(Lr, "handledProps", [
        "children",
    ...
    function Ur(e) {
      var t = e.blurring,
        ...
        i = e.content,
        u = e.dimmed,
        l = Xt()(nn(t, "blurring"), nn(u, "dimmed"), "dimmable", n),
        c = ln(Ur, e),
        s = cn(Ur, e);
      return a.a.createElement(
        s,
    ...
    var Fr = Ur,
      Br = (function (e) {
        function t() {
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(a)))),
            Wt()(Bt()(n), "containerRef", Object(o.createRef)()),
            Wt()(Bt()(n), "contentRef", Object(o.createRef)()),
            Wt()(Bt()(n), "handleClick", function (e) {
              var t = n.contentRef.current;
              Kt()(n.props, "onClick", e, n.props),
                (t && t !== e.target && Tr(t, e)) ||
                  Kt()(n.props, "onClickOutside", e, n.props);
            }),
            n
          );
        }
            ...
            },
            {
              ...
              value: function () {
                var e = this.props,
                  ...
                  d = Xt()(
                    "ui",
                    nn(n, "active transition visible"),
                    nn(l, "disabled"),
                    nn(c, "inverted"),
                    nn(s, "page"),
                    nn(f, "simple"),
                ...
                return a.a.createElement(
                  ...
                  a.a.createElement(
                    m,
                    Nt()({}, h, { className: d, onClick: this.handleClick }),
                    v &&
                      a.a.createElement(
                        "div",
    ...
    var Hr = (function (e) {
      function t() {
        ...
        return (
          (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
          Wt()(Bt()(n), "handlePortalMount", function () {
            br() &&
              (document.body.classList.add("dimmed"),
              document.body.classList.add("dimmable"));
          }),
          Wt()(Bt()(n), "handlePortalUnmount", function () {
            br() &&
            ...
            value: function () {
              ...
              return r
                ? a.a.createElement(
                    ...
                    a.a.createElement(Br, Nt()({}, o, { active: n, page: r }))
                  )
                : a.a.createElement(Br, Nt()({}, o, { active: n, page: r }));
            },
          },
    ...
    Wt()(Hr, "Dimmable", Fr),
      Wt()(Hr, "Inner", Br),
      Wt()(Hr, "handledProps", ["active", "page"]),
      (Hr.propTypes = {}),
      (Hr.create = Xn(Hr, function (e) {
        return { content: e };
      })),
      (Vr.handledProps = ["as", "children", "className", "content", "size"]),
      (Vr.propTypes = {});
    var $r = Vr;
    function Wr(e) {
      var t = e.avatar,
        ...
        _ = T[1],
        j = cn(Wr, e, function () {
          if (!(fn()(s) && fn()(y) && fn()(E) && r.isNil(i))) return "div";
        });
      return r.isNil(i)
        ? r.isNil(c)
          ? "img" === j
            ? a.a.createElement(j, Nt()({}, _, P, { className: O }))
            : a.a.createElement(
                j,
                Nt()({}, _, { className: O, href: m }),
                Hr.create(s, { autoGenerateKey: !1 }),
                Xr.create(y, { autoGenerateKey: !1 }),
                a.a.createElement("img", P)
              )
          : a.a.createElement(j, Nt()({}, S, { className: O }), c)
        : a.a.createElement(j, Nt()({}, S, { className: O }), i);
    }
    (Wr.handledProps = [
      "as",
      "avatar",
      ...
      (Wr.Group = $r),
      (Wr.propTypes = {}),
      (Wr.defaultProps = { as: "img", ui: !0 }),
      (Wr.create = Xn(Wr, function (e) {
        return { src: e };
      }));
    var qr = Wr;
    function Kr(e) {
    ...
    (Kr.handledProps = ["as", "children", "className", "content"]),
      (Kr.propTypes = {}),
      (Kr.create = Xn(Kr, function (e) {
        return { content: e };
      }));
    var Qr = Kr;
    function Gr(e) {
      var t = e.children,
        ...
        l = e.size,
        c = e.tag,
        s = Xt()("ui", i, l, nn(n, "circular"), nn(c, "tag"), "labels", o),
        f = ln(Gr, e),
        p = cn(Gr, e);
      return a.a.createElement(
        p,
      ...
      Xr = (function (e) {
        function t() {
          ...
          return (
            ...
            Wt()(Bt()(n), "handleIconOverrides", function (e) {
              return {
                onClick: function (t) {
                  Kt()(e, "onClick", t), Kt()(n.props, "onRemove", t, n.props);
                },
              };
            }),
            n
          ...
          It()(t, [
            {
              ...
              value: function () {
                ...
                if (!r.isNil(u))
                  return a.a.createElement(
                    _,
                    Nt()({}, P, { className: T, onClick: this.handleClick }),
                    u
                  );
                var j = ar()(E) ? "delete" : E;
                return a.a.createElement(
                  _,
                  Nt()({ className: T, onClick: this.handleClick }, P),
                  rr.create(y, { autoGenerateKey: !1 }),
                  "boolean" != typeof b &&
                    qr.create(b, { autoGenerateKey: !1 }),
                  f,
                  Qr.create(d, { autoGenerateKey: !1 }),
                  g &&
                    rr.create(j, {
                      autoGenerateKey: !1,
    ...
    function Jr(e) {
      var t = e.children,
        ...
        i = e.hidden,
        u = e.visible,
        l = Xt()(nn(u, "visible"), nn(i, "hidden"), "content", n),
        c = ln(Jr, e),
        s = cn(Jr, e);
      return a.a.createElement(
        s,
    ...
    function oo(e) {
      ...
      return a.a.createElement(
        i,
        Nt()({}, o, { className: r, "data-text": n })
      );
    }
    (oo.handledProps = ["as", "className", "text"]), (oo.propTypes = {});
    var ao = oo,
      io = (function (e) {
        function t() {
          var e, n;
          ...
          for (var a = arguments.length, i = new Array(a), u = 0; u < a; u++)
            i[u] = arguments[u];
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(i)))),
            Wt()(Bt()(n), "ref", Object(o.createRef)()),
            Wt()(Bt()(n), "computeElementType", function () {
              var e = n.props,
                t = e.attached,
                r = e.label;
              if (!fn()(t) || !fn()(r)) return "div";
            }),
            Wt()(Bt()(n), "computeTabIndex", function (e) {
              var t = n.props,
                r = t.disabled,
                o = t.tabIndex;
              return fn()(o) ? (r ? -1 : "div" === e ? 0 : void 0) : o;
            }),
            Wt()(Bt()(n), "focus", function () {
              return Kt()(n.ref.current, "focus");
            }),
            Wt()(Bt()(n), "handleClick", function (e) {
              n.props.disabled
                ? e.preventDefault()
            ...
            Wt()(Bt()(n), "hasIconClass", function () {
              var e = n.props,
                t = e.labelPosition,
                o = e.children,
                a = e.content,
                i = e.icon;
              return !0 === i || (i && (t || (r.isNil(o) && fn()(a))));
            }),
            n
          );
        }
          ...
          It()(t, [
            {
              ...
              value: function (e) {
                ...
                return fn()(t) ? ("button" !== e ? "button" : void 0) : t;
              },
            },
            {
              key: "render",
              value: function () {
                var e = this.props,
                  ...
                  _ = Xt()(on(w || !!g, "labeled")),
                  j = Xt()(nn(h, "disabled"), rn(m, "floated")),
                  N = ln(t, this.props),
                  R = cn(t, this.props, this.computeElementType),
                  D = this.computeTabIndex(R);
                if (!fn()(g)) {
                  var A = Xt()("ui", P, "button", s),
                    I = Xt()("ui", _, "button", s, j),
                    M = Xr.create(g, {
                      defaultProps: {
                        basic: !0,
                  ...
                  return a.a.createElement(
                    R,
                    Nt()({}, N, { className: I, onClick: this.handleClick }),
                    "left" === w && M,
                    a.a.createElement(
                      Cn,
                      { innerRef: this.ref },
                ...
                return a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    z && l,
                    !z && rr.create(y, { autoGenerateKey: !1 }),
                    !z && d
                  )
                );
              },
    ...
    var uo = io,
      ...
      po = (function (e) {
        function t() {
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(a)))),
            Wt()(Bt()(n), "inputRef", Object(o.createRef)()),
            Wt()(Bt()(n), "labelRef", Object(o.createRef)()),
            Wt()(Bt()(n), "canToggle", function () {
              var e = n.props,
                t = e.disabled,
                r = e.radio,
                o = e.readOnly,
            ...
            Wt()(Bt()(n), "computeTabIndex", function () {
              var e = n.props,
                t = e.disabled,
                r = e.tabIndex;
              return fn()(r) ? (t ? -1 : 0) : r;
            ...
            Wt()(Bt()(n), "handleClick", function (e) {
              var t = n.props.id,
                ...
                o = r.checked,
                a = r.indeterminate,
                i = Kt()(n.inputRef.current, "contains", e.target),
                u = Kt()(n.labelRef.current, "contains", e.target),
                l = !u && !i,
                c = !fn()(t);
              (u && c) ||
                Kt()(
            ...
            Wt()(Bt()(n), "handleChange", function (e) {
            ...
            Wt()(Bt()(n), "handleMouseDown", function (e) {
              var t = n.state,
                r = t.checked,
                o = t.indeterminate;
              Kt()(
                ...
                e.defaultPrevented || Kt()(n.inputRef.current, "focus"),
                e.preventDefault();
            }),
            Wt()(Bt()(n), "handleMouseUp", function (e) {
              var t = n.state,
                r = t.checked,
                o = t.indeterminate;
            ...
            Wt()(Bt()(n), "setIndeterminate", function () {
              var e = n.state.indeterminate;
              fo()(n.inputRef, "current.indeterminate", !!e);
            }),
            n
          );
        }
            ...
            },
            {
              ...
              value: function () {
                ...
                return a.a.createElement(
                  ...
                  a.a.createElement(Cn, { innerRef: this.labelRef }, O)
                );
              },
            },
          ]),
    ...
    function ho(e) {
      ...
      return a.a.createElement(
        po,
        Nt()({}, o, { type: r, radio: i, slider: t, toggle: n })
      );
    }
    Wt()(po, "defaultProps", { type: "checkbox" }),
      Wt()(po, "autoControlledProps", ["checked", "indeterminate"]),
      Wt()(po, "handledProps", [
        "as",
        "checked",
        "className",
      ...
      (po.propTypes = {}),
      (ho.handledProps = ["slider", "toggle", "type"]),
      (ho.propTypes = {}),
      (ho.defaultProps = { type: "radio" });
    var mo = ho;
    function vo(e) {
      var t = e.children,
        n = e.className,
      ...
      return "input" !== u || ("checkbox" !== d && "radio" !== d)
        ? u === po || u === mo
          ...
          : a.a.createElement(
              b,
              { className: v },
              Zn(f, { defaultProps: { htmlFor: m }, autoGenerateKey: !1 }),
              x,
    ...
    function bo(e) {
      var t = e.control,
        n = ln(bo, e),
        r = cn(bo, e);
      return a.a.createElement(r, Nt()({}, n, { control: t }));
    }
    (bo.handledProps = ["as", "control"]),
      (bo.propTypes = {}),
      (bo.defaultProps = { as: yo, control: uo });
    var go = bo;
    function wo(e) {
      var t = e.control,
        n = ln(wo, e),
    ...
    (wo.handledProps = ["as", "control"]),
      (wo.propTypes = {}),
      (wo.defaultProps = { as: yo, control: po });
    var xo = wo,
      Eo = n(152),
      ko = n.n(Eo),
      Oo = n(153),
    ...
    function Jo(e) {
      var t = e.className,
        ...
        r = ln(Jo, e),
        o = cn(Jo, e);
      return a.a.createElement(o, Nt()({}, r, { className: n }));
    }
    (Jo.handledProps = ["as", "className"]), (Jo.propTypes = {});
    var Zo = Jo,
      ea = (function (e) {
        function t() {
          return Dt()(this, t), Lt()(this, Ut()(t).apply(this, arguments));
        }
        return (
          Vt()(t, e),
          It()(t, [
            {
              ...
              value: function () {
                var e = this.props,
                  ...
                  i = ln(t, this.props),
                  u = cn(t, this.props);
                return a.a.createElement(u, Nt()({}, i, { className: o }));
              },
            },
          ]),
          t
    ...
    Wt()(ea, "defaultProps", { as: "i" }),
      Wt()(ea, "handledProps", ["as", "className", "name"]),
      (ea.propTypes = {}),
      (ea.create = Xn(ea, function (e) {
        return { name: e };
      }));
    var ta = ea,
      na = (function (e) {
          ...
          It()(t, [
            {
              ...
              value: function () {
                ...
                if (!r.isNil(o))
                  return a.a.createElement(
                    g,
                    Nt()({}, b, w, { className: v, onClick: this.handleClick }),
                    o
                  );
                var x = ta.create(s, { autoGenerateKey: !1 }),
                  E = rr.create(y, { autoGenerateKey: !1 }),
                  k = qr.create(p, { autoGenerateKey: !1 }),
                  O = Xr.create(d, { autoGenerateKey: !1 }),
                  S = Yn(
                    "span",
                    function (e) {
                      return { children: e };
    ...
    function oa(e) {
      ...
      return r.isNil(t)
        ? a.a.createElement(
            c,
            Nt()({}, l, { className: u }),
            rr.create(i, { autoGenerateKey: !1 }),
            o
          )
        : a.a.createElement(c, Nt()({}, l, { className: u }), t);
    }
    (oa.handledProps = ["as", "children", "className", "content", "icon"]),
      (oa.propTypes = {}),
      (oa.create = Xn(oa, function (e) {
        return { content: e };
      }));
    var aa = oa;
    function ia(e) {
      var t = e.children,
        ...
        u = e.open,
        l = e.scrolling,
        c = Xt()(i, nn(u, "visible"), nn(l, "scrolling"), "menu transition", n),
        s = ln(ia, e),
        f = cn(ia, e);
      return a.a.createElement(
        f,
      ...
      la = (function (e) {
        function t() {
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
            Wt()(Bt()(n), "handleChange", function (e) {
              var t = co()(e, "target.value");
              Kt()(n.props, "onChange", e, In()({}, n.props, { value: t }));
            }),
            n
          );
        }
    ...
    Wt()(la, "defaultProps", { autoComplete: "off", type: "text" }),
      Wt()(la, "handledProps", [
        "as",
        "autoComplete",
        "className",
      ...
      fa = (function (e) {
        function t() {
          ...
          for (var i = arguments.length, u = new Array(i), l = 0; l < i; l++)
            u[l] = arguments[l];
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(u)))),
            Wt()(Bt()(n), "searchRef", Object(o.createRef)()),
            Wt()(Bt()(n), "sizerRef", Object(o.createRef)()),
            Wt()(Bt()(n), "ref", Object(o.createRef)()),
            Wt()(Bt()(n), "handleChange", function (e, t) {
              Kt()(n.props, "onChange", e, In()({}, n.props, { value: t }));
            }),
            Wt()(Bt()(n), "closeOnChange", function (e) {
              var t = n.props,
                r = t.closeOnChange,
                o = t.multiple;
              (ar()(r) ? !o : r) && n.close(e, Ko.a);
            }),
            Wt()(Bt()(n), "closeOnEscape", function (e) {
              n.props.closeOnEscape &&
                Er.a.getCode(e) === Er.a.Escape &&
                (e.preventDefault(), n.close(e));
            }),
            Wt()(Bt()(n), "moveSelectionOnKeyDown", function (e) {
              var t,
                r = n.props,
                o = r.multiple,
                a = r.selectOnNavigation,
                i = ((t = {}),
                Wt()(t, Er.a.ArrowDown, 1),
                Wt()(t, Er.a.ArrowUp, -1),
                t)[Er.a.getCode(e)];
              void 0 !== i &&
                (e.preventDefault(),
            ...
            Wt()(Bt()(n), "openOnSpace", function (e) {
              Er.a.getCode(e) === Er.a.Spacebar &&
                (e.preventDefault(), n.open(e));
            }),
            Wt()(Bt()(n), "openOnArrow", function (e) {
              var t = Er.a.getCode(e);
              cr()([Er.a.ArrowDown, Er.a.ArrowUp], t) &&
                (n.state.open || (e.preventDefault(), n.open(e)));
            }),
            Wt()(Bt()(n), "makeSelectedItemActive", function (e) {
              var t = n.state,
                r = t.open,
                o = t.value,
                a = n.props.multiple,
            ...
            Wt()(Bt()(n), "selectItemOnEnter", function (e) {
              var t = n.props.search;
              if (
                Er.a.getCode(e) === Er.a.Enter ||
                (!t && Er.a.getCode(e) === Er.a.Spacebar)
              ) {
                e.preventDefault();
                var r = Bo()(n.getMenuOptions());
                (t && 0 === r) ||
                  (n.makeSelectedItemActive(e),
                  n.closeOnChange(e),
                  n.clearSearchQuery(),
                  t && Kt()(n.searchRef.current, "focus"));
              }
            }),
            Wt()(Bt()(n), "removeItemOnBackspace", function (e) {
              var t = n.props,
                r = t.multiple,
                o = t.search,
                a = n.state,
            ...
            Wt()(Bt()(n), "closeOnDocumentClick", function (e) {
              n.props.closeOnBlur &&
                ((n.ref.current && Tr(n.ref.current, e)) || n.close());
            }),
            Wt()(Bt()(n), "handleMouseDown", function (e) {
              (n.isMouseDown = !0),
                Kt()(n.props, "onMouseDown", e, n.props),
                document.addEventListener("mouseup", n.handleDocumentMouseUp);
            }),
            Wt()(Bt()(n), "handleDocumentMouseUp", function () {
              (n.isMouseDown = !1),
            ...
            Wt()(Bt()(n), "handleClick", function (e) {
              var t = n.props,
                ...
                u = a.searchQuery;
              if (
                (Kt()(n.props, "onClick", e, n.props), e.stopPropagation(), !o)
              )
                return n.toggle(e);
              i
                ? Kt()(n.searchRef.current, "focus")
                : u.length >= r || 1 === r
                ? n.open(e)
                : Kt()(n.searchRef.current, "focus");
            }),
            Wt()(Bt()(n), "handleIconClick", function (e) {
            ...
            Wt()(Bt()(n), "handleItemClick", function (e, t) {
              var r = n.props,
                o = r.multiple,
                a = r.search,
                i = n.state.value,
            ...
            Wt()(Bt()(n), "handleFocus", function (e) {
              n.state.focus ||
                (Kt()(n.props, "onFocus", e, n.props),
                n.setState({ focus: !0 }));
            }),
            Wt()(Bt()(n), "handleBlur", function (e) {
              var t = co()(e, "currentTarget");
              if (!t || !t.contains(document.activeElement)) {
                var r = n.props,
                  ...
                  i = r.selectOnBlur;
                n.isMouseDown ||
                  (Kt()(n.props, "onBlur", e, n.props),
                  i && !a && (n.makeSelectedItemActive(e), o && n.close()),
                  n.setState({ focus: !1 }),
                  n.clearSearchQuery());
              }
            }),
            Wt()(Bt()(n), "handleSearchChange", function (e, t) {
              var r = t.value;
              e.stopPropagation();
            ...
            Wt()(Bt()(n), "getKeyAndValues", function (e) {
              return e
                ? e.map(function (e) {
                    return Lo()(e, ["key", "value"]);
                  })
                : e;
            }),
            Wt()(Bt()(n), "getMenuOptions", function () {
              var e =
            ...
            Wt()(Bt()(n), "getSelectedItem", function () {
              var e = n.state.selectedIndex,
                t = n.getMenuOptions();
              return co()(t, "[".concat(e, "]"));
            }),
            Wt()(Bt()(n), "getEnabledIndices", function (e) {
            ...
            Wt()(Bt()(n), "getItemByValue", function (e) {
              var t = n.props.options;
              return Pn()(t, { value: e });
            }),
            Wt()(Bt()(n), "getMenuItemIndexByValue", function (e, t) {
              var r = t || n.getMenuOptions();
              return _o()(r, ["value", e]);
            }),
            Wt()(Bt()(n), "getDropdownAriaOptions", function () {
              var e = n.props,
                t = e.loading,
                r = e.disabled,
                o = e.search,
            ...
            Wt()(Bt()(n), "clearSearchQuery", function (e) {
            ...
            Wt()(Bt()(n), "setValue", function (e) {
              n.trySetState({ value: e });
            }),
            Wt()(Bt()(n), "setSelectedIndex", function () {
              var e,
                t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
            ...
            Wt()(Bt()(n), "handleLabelClick", function (e, t) {
              e.stopPropagation(),
                n.setState({ selectedLabel: t.value }),
                Kt()(n.props, "onLabelClick", e, t);
            }),
            Wt()(Bt()(n), "handleLabelRemove", function (e, t) {
              e.stopPropagation();
              var r = n.state.value,
                o = Gt()(r, t.value);
              n.setValue(o), n.setSelectedIndex(o), n.handleChange(e, o);
            }),
            Wt()(Bt()(n), "moveSelectionBy", function (e) {
              var t =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ? arguments[1]
                    : n.state.selectedIndex,
                r = n.getMenuOptions();
              if (void 0 !== r && !To()(r, "disabled")) {
                var o = r.length - 1,
            ...
            Wt()(Bt()(n), "handleIconOverrides", function (e) {
              var t = n.props.clearable;
              return {
                className: Xt()(t && n.hasValue() && "clear", e.className),
                onClick: function (t) {
                  Kt()(e, "onClick", t, e), n.handleIconClick(t);
                },
              };
            }),
            Wt()(Bt()(n), "clearValue", function (e) {
              var t = n.props.multiple ? [] : "";
              n.setValue(t), n.setSelectedIndex(t), n.handleChange(e, t);
            }),
            Wt()(Bt()(n), "computeSearchInputTabIndex", function () {
              var e = n.props,
                t = e.disabled,
                r = e.tabIndex;
              return fn()(r) ? (t ? -1 : 0) : r;
            }),
            Wt()(Bt()(n), "computeSearchInputWidth", function () {
            ...
            Wt()(Bt()(n), "computeTabIndex", function () {
              var e = n.props,
                ...
                r = e.search,
                o = e.tabIndex;
              if (!r) return t ? -1 : fn()(o) ? 0 : o;
            }),
            Wt()(Bt()(n), "handleSearchInputOverrides", function (e) {
              return {
                onChange: function (t, r) {
                  Kt()(e, "onChange", t, r), n.handleSearchChange(t, r);
                },
              };
            }),
            Wt()(Bt()(n), "hasValue", function () {
              var e = n.props.multiple,
                t = n.state.value;
              return e ? !Nr()(t) : !fn()(t) && "" !== t;
            }),
            Wt()(Bt()(n), "scrollSelectedItemIntoView", function () {
              if (n.ref.current) {
            ...
            Wt()(Bt()(n), "setOpenDirection", function () {
              if (n.ref.current) {
                var e = n.ref.current.querySelector(".menu.visible");
                if (e) {
            ...
            Wt()(Bt()(n), "open", function (e) {
              var t = n.props,
                ...
                o = (t.open, t.search);
              r ||
                (o && Kt()(n.searchRef.current, "focus"),
                Kt()(n.props, "onOpen", e, n.props),
            ...
            Wt()(Bt()(n), "close", function (e) {
              var t =
                ...
                r = n.state.open;
              r &&
                (Kt()(n.props, "onClose", e, n.props),
                n.trySetState({ open: !1 }, t));
            }),
            Wt()(Bt()(n), "handleClose", function () {
            ...
            Wt()(Bt()(n), "toggle", function (e) {
              return n.state.open ? n.close(e) : n.open(e);
            }),
            Wt()(Bt()(n), "renderText", function () {
              var e = n.props,
                t = e.multiple,
                r = e.placeholder,
                o = e.search,
                ...
                s = u.open,
                f = n.hasValue(),
                p = Xt()(r && !f && "default", "text", o && l && "filtered"),
                d = r;
              return (
                i
                  ? (d = i)
                  : s && !t
                  ? (d = co()(n.getSelectedItem(), "text"))
                  : f && (d = co()(n.getItemByValue(c), "text")),
                a.a.createElement(
                  "div",
                  {
                    className: p,
            ...
            Wt()(Bt()(n), "renderSearchInput", function () {
              var e = n.props,
                t = e.search,
                r = e.searchInput,
            ...
            Wt()(Bt()(n), "renderSearchSizer", function () {
              var e = n.props,
                t = e.search,
                r = e.multiple;
              return (
            ...
            Wt()(Bt()(n), "renderLabels", function () {
              var e = n.props,
                ...
                i = o.value;
              if (t && !Nr()(i)) {
                var u = to()(i, n.getItemByValue);
                return to()(So()(u), function (e, t) {
                  var o = {
                    active: e.value === a,
                    as: "a",
                  ...
                  return Xr.create(r(e, t, o), { defaultProps: o });
                });
              }
            }),
            Wt()(Bt()(n), "renderOptions", function () {
              var e = n.props,
                t = e.lazyLoad,
                r = e.multiple,
                o = e.search,
            ...
            Wt()(Bt()(n), "renderMenu", function () {
              ...
              if (!r.isNil(t)) {
                var s = o.Children.only(t),
                  f = Xt()(i, nn(l, "visible"), s.props.className);
                return Object(o.cloneElement)(s, In()({ className: f }, c));
              }
              return a.a.createElement(
                ua,
                Nt()({}, c, { direction: i, open: l }),
                aa.create(u, { autoGenerateKey: !1 }),
                n.renderOptions()
              );
            }),
            n
        ...
        return (
          ...
          It()(t, [
            ...
            },
            {
              ...
              value: function (e, t) {
                return !Xo()(e, this.props) || !Xo()(t, this.state);
              },
            },
            {
              key: "componentDidUpdate",
    ...
    Wt()(fa, "defaultProps", {
      ...
      (pa.propTypes = {}),
      (pa.defaultProps = { as: yo, control: fa });
    var da = pa;
    function ha(e) {
      var t = e.children,
        n = e.className,
        ...
        c = ln(ha, e),
        s = cn(ha, e);
      return a.a.createElement(s, Nt()({}, c, { className: l }), t);
    }
    (ha.handledProps = [
      "as",
      "children",
      ...
      va = (function (e) {
        function t() {
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(a)))),
            Wt()(Bt()(n), "inputRef", Object(o.createRef)()),
            Wt()(Bt()(n), "computeIcon", function () {
              var e = n.props,
                t = e.loading,
                r = e.icon;
              return fn()(r) ? (t ? "spinner" : void 0) : r;
            }),
            Wt()(Bt()(n), "computeTabIndex", function () {
              var e = n.props,
                t = e.disabled,
                r = e.tabIndex;
              return fn()(r) ? (t ? -1 : void 0) : r;
            }),
            Wt()(Bt()(n), "focus", function () {
              return n.inputRef.current.focus();
            }),
            Wt()(Bt()(n), "select", function () {
            ...
            Wt()(Bt()(n), "handleChildOverrides", function (e, t) {
              return In()({}, t, e.props, {
                ref: function (t) {
                  En(e.ref, t), (n.inputRef.current = t);
                },
              });
            }),
            Wt()(Bt()(n), "partitionProps", function () {
              var e = n.props,
                r = e.disabled,
                o = e.type,
                a = n.computeTabIndex(),
              ...
              value: function () {
                var e = this,
                  ...
                  O = Xt()(
                    ...
                    nn(w, "loading"),
                    nn(E, "transparent"),
                    rn(u, "action") || nn(i, "action"),
                    rn(m, "icon") || nn(h || w, "icon"),
                    rn(g, "labeled") || nn(b, "labeled"),
                    "input",
                    c
                  ),
                  S = cn(t, this.props),
                  ...
                  _ = T[1];
                if (!r.isNil(l)) {
                  var j = to()(o.Children.toArray(l), function (t) {
                    return "input" !== t.type
                      ? t
                      : Object(o.cloneElement)(t, e.handleChildOverrides(t, P));
                  });
                  return a.a.createElement(S, Nt()({}, _, { className: O }), j);
                }
                var N = uo.create(i, { autoGenerateKey: !1 }),
                  R = Xr.create(b, {
                    defaultProps: {
                      className: Xt()("label", cr()(g, "corner") && g),
                    },
                    autoGenerateKey: !1,
                  });
                return a.a.createElement(
                  ...
                  "left" === u && N,
                  "right" !== g && R,
                  Jn(v || k, { defaultProps: P, autoGenerateKey: !1 }),
                  rr.create(this.computeIcon(), { autoGenerateKey: !1 }),
                  "left" !== u && N,
                  "right" === g && R
                );
              },
    ...
    (ba.handledProps = ["as", "control"]),
      (ba.propTypes = {}),
      (ba.defaultProps = { as: yo, control: ya });
    var ga = ba;
    function wa(e) {
      var t = e.control,
        n = ln(wa, e),
    ...
    (wa.handledProps = ["as", "control"]),
      (wa.propTypes = {}),
      (wa.defaultProps = { as: yo, control: mo });
    var xa = wa;
    function Ea(e) {
      return a.a.createElement(fa, Nt()({}, e, { selection: !0 }));
    }
    (Ea.handledProps = ["options"]),
      (Ea.propTypes = {}),
      (Ea.Divider = fa.Divider),
      (Ea.Header = fa.Header),
      (Ea.Item = fa.Item),
      (Ea.Menu = fa.Menu);
    var ka = Ea;
    function Oa(e) {
      var t = e.control,
        ...
        r = ln(Oa, e),
        o = cn(Oa, e);
      return a.a.createElement(o, Nt()({}, r, { control: t, options: n }));
    }
    (Oa.handledProps = ["as", "control", "options"]),
      (Oa.propTypes = {}),
      (Oa.defaultProps = { as: yo, control: ka });
    var Sa = Oa,
      Ca = (function (e) {
        function t() {
          var e, n;
          ...
          return (
            ...
            Wt()(Bt()(n), "handleInput", function (e) {
              var t = co()(e, "target.value");
              Kt()(n.props, "onInput", e, In()({}, n.props, { value: t }));
            }),
            n
          );
        }
    ...
    Wt()(Ca, "defaultProps", { as: "textarea", rows: 3 }),
      Wt()(Ca, "handledProps", ["as", "onChange", "onInput", "rows", "value"]),
      (Ca.propTypes = {});
    var Ta = Ca;
    function Pa(e) {
      var t = e.control,
    ...
    (Pa.handledProps = ["as", "control"]),
      (Pa.propTypes = {}),
      (Pa.defaultProps = { as: yo, control: Ta });
    var _a = Pa,
      ja = (function (e) {
        function t() {
          var e, n;
          ...
          return (
            (n = Lt()(this, (e = Ut()(t)).call.apply(e, [this].concat(o)))),
            Wt()(Bt()(n), "handleSubmit", function (e) {
              var t = n.props.action;
              "string" != typeof t && Kt()(e, "preventDefault");
              for (
                ...
                o[a - 1] = arguments[a];
              Kt.a.apply(void 0, [n.props, "onSubmit", e, n.props].concat(o));
            }),
            n
          );
        }
    ...
    function Ia(e) {
      console.log(e),
        e
          ? (Da.a.defaults.headers.common.Authorization = "Bearer ".concat(e))
          : delete Da.a.defaults.headers.common.Authorization;
    }
    function Ma(e) {
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.target.value;
              this.setState(function (e) {
                return Fa(Fa({}, e), {}, { passwordConfirm: t });
              });
            },
          },
          {
    ...
    Qa.propTypes = { signup: s.a.func.isRequired };
    var Ga = ee(
        Je(null, {
          signup: function (e) {
            return function (t) {
              return Da.a.post("".concat(Aa, "/auth/signup"), e);
            };
          },
        })(Qa)
      ),
    ...
    function ai(e, t) {
      return !t || ("object" !== Ja(t) && "function" != typeof t) ? ii(e) : t;
    }
    function ii(e) {
      if (void 0 === e)
        throw new ReferenceError(
    ...
    var li = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (t.handleEmailChange = t.handleEmailChange.bind(ii(t))),
          (t.handlePasswordChange = t.handlePasswordChange.bind(ii(t))),
          (t.handleLogin = t.handleLogin.bind(ii(t))),
          t
        );
      }
      return (
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              var t = e.target.value;
              this.setState(function (e) {
                return ei(ei({}, e), {}, { passwordInput: t });
              });
            },
          },
          {
    ...
    li.propTypes = { login: s.a.func.isRequired };
    var ci = ee(
        Je(null, {
          login: function (e) {
            return function (t) {
              return Da.a
                .post("".concat(Aa, "/auth/login"), e)
                .then(function (e) {
                  var n = e.data;
                  localStorage.setItem("jwtToken", n), Ia(n), t(Ma(Ot()(n)));
                });
            };
          },
        })(li)
    ...
    var xi = (function (e) {
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                try {
                  for (o.s(); !(r = o.n()).done; ) {
                    var i = r.value;
                    n[-1] = n[-1].concat(i.user_comments);
                  }
                } catch (e) {
                  o.e(e);
                } finally {
      ...
      Ei = function (e) {
        return a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(_t, { baseClass: "Comments" }, e.body)
          )
        );
      },
      ki = function (e) {
        return a.a.createElement(
          ...
          a.a.createElement(Na.TextArea, null),
      ...
      Si = function (e) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement(rr, { name: e.icon, size: t, color: n })
        );
      };
    Si.propTypes = {
      baseClass: s.a.string.isRequired,
    ...
    function Ni(e, t) {
      return !t || ("object" !== Ti(t) && "function" != typeof t) ? Ri(e) : t;
    }
    function Ri(e) {
      if (void 0 === e)
        throw new ReferenceError(
    ...
    var Ai = (function (e) {
        ...
        function i(e) {
          ...
          return (
            ...
            (t.navigateToSettings = t.navigateToSettings.bind(Ri(t))),
            (t.navigateToTeamOverview = t.navigateToTeamOverview.bind(Ri(t))),
            (t.navigateToAdmin = t.navigateToAdmin.bind(Ri(t))),
            t
          );
        }
        return (
              ...
              value: function () {
                ...
                return a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      Ii,
                      {
                        key: n,
                        onClick: function () {
                          return e.props.onUserSelected(n);
                        },
                        icon: "user",
                        isSelected: n == this.props.selectedUserId,
                      },
                      r
                    ),
                    o.team_members.map(function (t, n) {
                      return a.a.createElement(
                        Ii,
                        {
                          key: t.member_id,
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      Ii,
                      { icon: "user secret", onClick: this.navigateToAdmin },
                      "Admin"
                    ),
                    a.a.createElement(
                      "div",
      ...
      Ii = function (e) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement(_t, { baseClass: "TaskbarItem" }, e.children)
        );
      },
      Mi = ee(
        Je(
          ...
          function (e) {
            return {
              ...
              logout: function () {
                localStorage.removeItem("jwtToken"), Ia(!1), e(Ma({}));
              },
            };
          }
        )(Ai)
    ...
    function eu(e, t) {
      return !t || ("object" !== Wi(t) && "function" != typeof t) ? tu(e) : t;
    }
    function tu(e) {
      if (void 0 === e)
        throw new ReferenceError(
    ...
    var ru = (function (e) {
        ...
        function i(e) {
          ...
          return (
            ...
            (t.selectItem = t.selectItem.bind(tu(t))),
            (t.handleNewTaskNameChange = t.handleNewTaskNameChange.bind(tu(t))),
            (t.handleNewTaskDescriptionChange = t.handleNewTaskDescriptionChange.bind(
              tu(t)
            )),
            (t.openAddModal = t.openAddModal.bind(tu(t))),
            (t.handleCancel = t.handleCancel.bind(tu(t))),
            t
          );
        }
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.target.value;
                this.setState(function (e) {
                  return Gi(Gi({}, e), {}, { newTaskDescription: t });
                });
              },
            },
            {
                        ...
                        return o[t].map(function (r) {
                          if (t == e.props.selectedUserId)
                            return a.a.createElement($i, {
                              ...
                              showButtons: n == t,
                              onClick: function () {
                                return e.props.onToDoSelected(r.goal_id);
                              },
                            });
                        });
                      })
    ...
    var pu = (function (e) {
        ...
        function i(e) {
          ...
          return (
            ...
            ((t = o.call(this, e)).state = { data: null }),
            t
          );
        }
        return (
              ...
              value: function () {
                if (this.state.data) {
                  ...
                  return a.a.createElement(
                    ...
                    a.a.createElement(Oi, { team: e.team })
                  );
                }
                return a.a.createElement(
                  "div",
                  ...
                  a.a.createElement(
                    Hr,
                    { active: !0, inverted: !0 },
                    a.a.createElement(pi, { inverted: !0, content: "Loading" })
                  )
                );
              },
            },
      ...
      du = Je(function (e) {
        return { userEmail: e.auth.user.user[0].email };
      })(pu);
    function hu(e) {
      return (hu =
        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
    ...
    var Ou = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (t.handleUsernameChange = t.handleUsernameChange.bind(Eu(t))),
          (t.handleUpdate = t.handleUpdate.bind(Eu(t))),
          t
        );
      }
      return (
        ...
        (n = [
          {
            ...
            value: function () {
              ...
              this.setState(function (t) {
                return vu(vu({}, t), {}, { usernameInput: e });
              });
            },
          },
          {
              ...
              return a.a.createElement(
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(rr, { name: "user", size: "massive" })
                  )
                )
              );
            },
    ...
    function Au(e, t) {
      return !t || ("object" !== Su(t) && "function" != typeof t) ? Iu(e) : t;
    }
    function Iu(e) {
      if (void 0 === e)
        throw new ReferenceError(
    ...
    var Lu = (function (e) {
      ...
      function i(e) {
        ...
        !(function (e, t) {
          ...
          (t.handleTeamCreateChange = t.handleTeamCreateChange.bind(Iu(t))),
          (t.handleTeamRequest = t.handleTeamRequest.bind(Iu(t))),
          (t.handleTeamCreate = t.handleTeamCreate.bind(Iu(t))),
          (t.teamOptions = []);
        var n,
          r = _u(t.props.teams);
        try {
        ...
        (n = [
          {
            ...
            value: function () {
              var e = event.target.value;
              this.setState(function (t) {
                return Tu(Tu({}, t), {}, { teamRequestInput: e });
              });
            },
          },
          {
    ...
    var $u = (function (e) {
              ...
              value: function () {
                return this.state.data
                  ? a.a.createElement(
                      ...
                      a.a.createElement(Lu, { teams: this.state.data.items })
                    )
                  : a.a.createElement(
                      "div",
                      { className: "Loader" },
      ...
      Wu = function (e) {
        return a.a.createElement(
          ...
          a.a.createElement(
            Ct,
            { hLevel: 1, baseClass: "TeamOverview" },
            e.teamName ? e.teamName : "Test Team Name"
          ),
          a.a.createElement(
            "div",
            { className: "TeamOverview-stats" },
    ...
    var nl = {
      ...
      rl = {
        toDos: function () {
          ...
          switch (n) {
            case "SELECT_TODO":
              var o = r.toDoID,
                a = el(el({}, e), {}, { selectedToDoId: o });
              return a;
            case "SELECT_USER":
              var i = r.userID,
                u = el(el({}, e), {}, { selectedUserId: i });
              return u;
            default:
              return e;
          }
      ...
      ol = mt({ key: "root", storage: Yu.a, stateReconciler: Ju.a }, De(rl));
    function al(e) {
      return (al =
        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
          ? function (e) {
    ...
    function sl(e, t) {
      return !t || ("object" !== al(t) && "function" != typeof t)
        ? (function (e) {
            if (void 0 === e)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
    ...
    var pl = function (e) {
      var t = (function (t) {
        ...
        var n,
          ...
          i = cl(u);
        function u() {
          return il(this, u), i.apply(this, arguments);
        }
        return (
          (n = u),
          (r = [
    ...
    var dl,
      ...
      gl,
      wl,
      xl = document.querySelector("#container"),
      El = function () {
        return a.a.createElement(
          te,
          null,
          a.a.createElement(
            ...
            a.a.createElement(
              Z,
              null,
              a.a.createElement(K, { exact: !0, path: "/", component: si }),
              a.a.createElement(K, {
                exact: !0,
                path: "/home",
                component: pl(du),
      ...
      Ol =
        ((dl = kl),
        (vl = ml || !1),
        (yl = Ne(xt, wt, hl && hl.enhancer ? hl.enhancer : void 0)),
        (bl = function (e) {
          yl.dispatch({ type: tt, key: e });
        }),
        (gl = function (e, t, n) {
          var r = { type: et, payload: t, err: n, key: e };
          dl.dispatch(r),
            yl.dispatch(r),
            vl && wl.getState().bootstrapped && (vl(), (vl = !1));
        }),
        (wl = bt({}, yl, {
          purge: function () {
            var e = [];
          ...
          pause: function () {
            dl.dispatch({ type: "persist/PAUSE" });
          },
          persist: function () {
            dl.dispatch({
        ...
        (hl && hl.manualPersist) || wl.persist(),
        wl);
    if (localStorage.jwtToken) {
      Ia(localStorage.jwtToken);
      try {
        kl.dispatch(Ma(Ot()(localStorage.jwtToken)));
      } catch (e) {
        kl.dispatch(Ma({}));
      }
    }
